...
// connect to MongoDB;
mongoose
    .connect("mongodb://localhost:27017", { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false })
...
app.get('/', (req, res) => res.send("Welcome Team 14 and NITC Student Guidance Cell"));
